...
public class BufferClassifier extends AbstractClassifier implements MultiClassClassifier,
        CapabilitiesHandler {
    /**
     *
     */
    ...
    public BufferClassifier() {
    }

    public BufferClassifier(String learnerCLI, int bufferSize, double relevanceRatio, String relevanceModelCLI, int randomSeed,
